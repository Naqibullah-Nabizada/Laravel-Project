...
@section('content')
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"> ویرایش مقدار فرم کالا</li>
        </ol>
    </nav>
        ...
        <section class="col-12">
            <section class="main-body-container">
                <section class="main-body-container-header">
                    ...
                    <h5>بخش ویرایش مقدار فرم کالا</h5>
                    ...
                    <section>
                        <form action="{{ route('property.value.update', [$categoryAttribute->id, $value->id]) }}"
                            method="POST">
                            @csrf
                            @method('PUT')
                            <section class="row">
                                ...
                                <div class="form-group col-12 col-md-6">
                                    ...
                                    <input type="text" name="value" class="form-control form-control-sm"
                                        placeholder="مقدار" value="{{ old('value', json_decode($value->value)->value) }}">
                                    @error('value')
                                        <p class="text-danger my-2">{{ $message }}</p>
                                    @enderror
                                </div>
