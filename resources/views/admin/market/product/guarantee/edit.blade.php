...
@section('head-tag')
    ...
    <title>ویرایش گارانتی محصول</title>
@endsection
...
@section('content')
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"> ویرایش گارانتی محصول</li>
        </ol>
    </nav>
        ...
        <section class="col-12">
            <section class="main-body-container">
                <section class="main-body-container-header">
                    ...
                    <section>
                        <form action="{{ route('product.guarantee.update', [$guarantee->id, $product->id]) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <section class="row border-bottom">
                                ...
                                <div class="form-group col-12 col-md-6">
                                    ...
                                    <input type="text" name="name" class="form-control form-control-sm"
                                        placeholder="نام گارانتی" value="{{ old('name', $guarantee->name) }}">
                                    @error('name')
                                ...
                                <div class="form-group col-12 col-md-6">
                                    ...
                                    <select name="status"
                                        ...
                                        <option value="0" @if (old('status', $guarantee->status) == 0) selected @endif>غیر فعال
                                        </option>
                                        <option value="1" @if (old('status', $guarantee->status) == 1) selected @endif>فعال
                                        </option>
                                    </select>
                                    @error('status')
                                        <p class="text-danger my-2">{{ $message }}</p>
