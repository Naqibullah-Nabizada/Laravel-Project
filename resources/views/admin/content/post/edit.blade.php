                            ...
                            <section class="row">
                                ...
                                <div class="form-group col-12 col-md-6">
                                    ...
                                    <input type="text" name="title" class="form-control form-control-sm"
                                        placeholder="عنوان پست" value="{{ old('title', $post->title) }}">
                                    @error('title')
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <input type="hidden" name="tags" class="form-control form-control-sm"
                                        placeholder="برچسپ ها" value="{{ old('tags', $post->tags) }}" id="tags">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <textarea name="summary" id="summary" rows="7" class="form-control" placeholder="خلاصه پست">{{ old('summary', $post->summary) }}</textarea>
                                    @error('summary')
                                        <p class="text-danger my-2">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <textarea name="body" id="body" rows="7" class="form-control" placeholder="متن پست">{{ old('body', $post->body) }}</textarea>
                                    @error('body')
                                        <p class="text-danger my-2">{{ $message }}</p>
                                    @enderror
                                </div>
