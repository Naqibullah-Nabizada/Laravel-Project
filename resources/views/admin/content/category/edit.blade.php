                            ...
                            <section class="row">
                                ...
                                <div class="form-group col-12 col-md-6">
                                    ...
                                    <input type="text" name="name"
                                        ...
                                        placeholder="نام دسته" value="{{ old('name', $postCategory->name) }}">
                                    @error('name')
                                ...
                                <div class="form-group col-12 col-md-6">
                                    ...
                                    <input type="hidden" name="tags"
                                        class="form-control form-control-sm @error('tags') is-invalid @enderror"
                                        placeholder="برچسپ ها" value="{{ old('tags', $postCategory->tags) }}"
                                        id="tags">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <textarea name="description" id="description" rows="7"
                                        class="form-control @error('description') is-invalid @enderror" placeholder="محتوا">{{ old('description', $postCategory->description) }}</textarea>
                                    @error('description')
                                        <p class="text-danger my-2">{{ $message }}</p>
                                    @enderror
                                </div>
