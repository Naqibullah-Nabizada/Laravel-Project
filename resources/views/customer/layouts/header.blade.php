            ...
            <section class="container-xxl ">
                <section class="d-md-flex justify-content-md-between align-items-md-center py-3">
                    ...
                    <section class="mt-3 mt-md-auto text-end">
                                ...
                                <section class="header-cart-dropdown">
                                    ...
                                    <section
                                        ...
                                        <section class=""><a class="btn btn-danger btn-sm d-block"
                                                href="cart.html">ثبت سفارش</a></section>
                                    </section>
                                </section>
                            </section>
                        @endauth
                        ...
                        @guest
                            <a href="{{ route('login-register-form') }}" class="btn btn-sm btn-primary">ورود / ثبت نام
                                        ...
                                        <section class="sublist-item-sublist">
                                            <section
                                                ...
                                                <section class="sublist-column col">
                                                    ...
                                                    <a href="#" class="sub-sub-category">دوربین عکاسی
                                                        دیجیتال</a>
                                                ...
                                                <section class="sublist-column col">
                                                    ...
                                                    <a href="#" class="sub-category">پلی استیشن، ایکس باکس و
                                                        بازی</a>
                                                    <a href="#" class="sub-category">کامپیوتر و تجهیزات
                                                        جانبی</a>
                                                    ...
                                                    <a href="#" class="sub-sub-category">قطعات داخلی
                                                        کامپیوتر</a>
                                                    ...
                                                    <a href="#" class="sub-sub-category">کابل صدا، AUX و
                                                        HDMI</a>
                                                </section>
                                                ...
                                                <section class="sublist-column col">
                                                    ...
                                                    <a href="#" class="sub-sub-category">تلفن، بیسیم و
                                                        سانترال</a>
                                        ...
                                        <section class="sublist-item-sublist">
                                            <section
                                                ...
                                                <section class="sublist-column col">
                                                    ...
                                                    <a href="#" class="sub-sub-category">نظافت و نگهداری
                                                        خودرو</a>
                                                    <a href="#" class="sub-sub-category">کلاه کاسکت و لوازم
                                                        جانبی موتور</a>
                                                ...
                                                <section class="sublist-column col">
                                                    ...
                                                    <a href="#" class="sub-sub-category">مکمل سوخت و روغن و
                                                        انواع فیلتر</a>
                                    ...
                                    <section class="sublist-item">
                                        ...
                                        <section class="sublist-item-sublist">
                                            <section
                                                class="sublist-item-sublist-wrapper d-flex justify-content-around align-items-center">
                                                <section class="sublist-column col">
                                                    <a href="#" class="sub-category">بهداشت و حمام کودک و
                                                        نوزاد</a>
                                                    ...
                                                    <a href="#" class="sub-category">پوشاک و کفش کودک و
                                                        نوزاد</a>
                                                    <a href="#" class="sub-sub-category">لباس کودک و لباس
                                                        نوزادی</a>
                                                ...
                                                <section class="sublist-column col">
                                                    ...
                                                    <a href="#" class="sub-sub-category">دشک بازی و پارک
                                                        بازی</a>
                                                ...
                                                <section class="sublist-column col">
                                                    ...
                                                    <a href="#" class="sub-sub-category">دوربین و پیجر اتاق
                                                        کودک</a>
                                                ...
                                                <section class="sublist-column col">
                                                    ...
                                                    <a href="#" class="sub-sub-category">لوازم جانبی گردش و
                                                        سفر</a>
                                    ...
                                    <section class="sublist-item">
                                        ...
                                        <section class="sublist-item-sublist">
                                            <section
                                                class="sublist-item-sublist-wrapper d-flex justify-content-around align-items-center">
                                                <section class="sublist-column col">
                                                    <a href="#" class="sub-category">کالای اساسی و خوار و
                                                        بار</a>
                                                    ...
                                                    <a href="#" class="sub-sub-category">آبلیمو، آبغوره و
                                                        سرکه</a>
                                                    <a href="#" class="sub-sub-category">ماکارونی، پاستا و
                                                        رشته</a>
                                                ...
                                                <section class="sublist-column col">
                                                    ...
                                                    <a href="#" class="sub-sub-category">حلواشکری، ارده و
                                                        کنجد</a>
                                                ...
                                                <section class="sublist-column col">
                                                    ...
                                                    <a href="#" class="sub-sub-category">شکلات، تافی و
                                                        آبنبات</a>
                                            ...
                                            <section
                                                ...
                                                <section class="sublist-column col">
                                                    ...
                                                    <a href="#" class="sub-sub-category">سنگ پا، بهداشت و زیبایی
                                                        ناخن</a>
                                                    <a href="#" class="sub-sub-category">تجهیزات جانبی
                                                        آرایشی</a>
                                                ...
                                                <section class="sublist-column col">
                                                    ...
                                                    <a href="#" class="sub-sub-category">مچ بند و ساعت
                                                        هوشمند</a>
                                                    <a href="#" class="sub-sub-category">ترازو</a>
                                        ...
                                        <section class="sublist-item-sublist">
                                            <section
                                                ...
                                                <section class="sublist-column col">
                                                    ...
                                                    <a href="#" class="sub-sub-category">سینمای خانگی و
                                                        ساندبار</a>
                                                    <a href="#" class="sub-sub-category">گیرنده دیجیتال
                                                        تلویزیون</a>
                                                    ...
                                                    <a href="#" class="sub-sub-category">ساعت دیواری و
                                                        رومیزی</a>
                                                ...
                                                <section class="sublist-column col">
                                                    ...
                                                    <a href="#" class="sub-sub-category">تلفن، بیسیم و
                                                        سانترال</a>
                                                    <a href="#" class="sub-sub-category">کولر، پنکه و تصفیه
                                                        هوا</a>
                                                    ...
                                                    <a href="#" class="sub-category">حیوانات خانگی، غذا و
                                                        لوازم</a>
                                                ...
                                                <section class="sublist-column col">
                                                    ...
                                                    <a href="#" class="sub-sub-category">پارچ، بطری، لیوان و
                                                        ماگ</a>
                                                ...
                                                <section class="sublist-column col">
                                                    ...
                                                    <a href="#" class="sub-category">ملحفه، سرویس، لوازم
                                                        خواب</a>
                                                    <a href="#" class="sub-category">حوله و وسایل حمام</a>
                                                    <a href="#" class="sub-category">پادری، کمد، لوازم اتاق
                                                        خواب</a>
                                        ...
                                        <section class="sublist-item-sublist">
                                            <section class="sublist-item-sublist-wrapper row">
                                                <section class="sublist-column col">
                                                    ...
                                                    <a href="#" class="sub-category">فیلم سینمایی، سریال و
                                                        مستند</a>
                                                ...
                                                <section class="sublist-column col">
                                                    ...
                                                    <a href="#" class="sub-sub-category">ابزار نقاشی و رنگ
                                                        آمیزی</a>
                                                ...
                                                <section class="sublist-column col">
                                                    ...
                                                    <a href="#" class="sub-sub-category">سفال، سرامیک و
                                                        چینی</a>
                                        ...
                                        <section class="sublist-item-sublist">
                                            <section
                                                ...
                                                <section class="sublist-column col">
                                                    ...
                                                    <a href="#" class="sub-sub-category">لوازم جانبی
                                                        دوچرخه</a>
                                                </section>
                                                ...
                                                <section class="sublist-column col">
                                                    ...
                                                    <a href="#" class="sub-sub-category">چراغ قوه و چراغ
                                                        پیشانی</a>
                                                    <a href="#" class="sub-sub-category">چاقو و ابزار چند
                                                        کاره</a>
                                                ...
                                                <section class="sublist-column col">
                                                    ...
                                                    <a href="#" class="sub-category">ورزش های هوازی و
                                                        بدنسازی</a>
                                                    <a href="#" class="sub-sub-category">تجهیزات جانبی ایروبیک
                                                        و تناسب اندام</a>
                                    ...
                                    <section class="sublist-item">
                                        ...
                                        <section class="sublist-item-sublist">
                                            <section
                                                class="sublist-item-sublist-wrapper d-flex justify-content-around align-items-center">
                                                <section class="sublist-column col">
                                                    <a href="#" class="sub-category">خوراکی های بومی و
                                                        محلی</a>
                                                    <a href="#" class="sub-sub-category">حلواشکری، ارده و
                                                        کنجد</a>
                                                    <a href="#" class="sub-sub-category">خرمای محلی</a>
                                                    <a href="#" class="sub-sub-category">عسل محلی</a>
                                                    <a href="#" class="sub-sub-category">عرقیات و گلاب
                                                        اصیل</a>
                                                    <a href="#" class="sub-sub-category">ادویه و چاشنی
                                                        محلی</a>
                                                    <a href="#" class="sub-sub-category">چای محلی</a>
                                                    <a href="#" class="sub-sub-category">زعفران، زرشک و
                                                        تزئینات غذا</a>
                                                    <a href="#" class="sub-sub-category">سبزی خشک محلی</a>
                                                    <a href="#" class="sub-sub-category">حبوبات و سویای
                                                        محلی</a>
                                                ...
                                                <section class="sublist-column col">
                                                    <a href="#" class="sub-category">خانه و کاشانه بومی
                                                        محلی</a>
                                                    ...
                                                    <a href="#" class="sub-sub-category">شکلات خوری دست
                                                        ساز</a>
                                                ...
                                                <section class="sublist-column col">
                                                    ...
                                                    <a href="#" class="sub-sub-category">چراغ خواب و
                                                        آباژور</a>
                                                    ...
                                                    <a href="#" class="sub-category">پوشیدنی های بومی و
                                                        محلی</a>
                                                    <a href="#" class="sub-sub-category">پوشاک بومی و محلی</a>
                                                    <a href="#" class="sub-sub-category">اکسسوری بومی و
                                                        محلی</a>
                                                </section>
