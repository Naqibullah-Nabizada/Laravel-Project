            ...
            <section class="col-md-8 pe-md-1 ">
                <section id="slideshow" class="owl-carousel owl-theme">
                    <section class="item"><a class="w-100 d-block h-auto text-decoration-none" href="#"><img
                                ...
                                src="{{ asset('customer-assets/images/slideshow/1.jpg') }}" alt=""></a>
                    </section>
                    <section class="item"><a class="w-100 d-block h-auto text-decoration-none" href="#"><img
                                class="w-100 rounded-2 d-block h-auto"
                                src="{{ asset('customer-assets/images/slideshow/2.jpg') }}" alt=""></a></section>
                    <section class="item"><a class="w-100 d-block h-auto text-decoration-none" href="#"><img
                                class="w-100 rounded-2 d-block h-auto"
                                src="{{ asset('customer-assets/images/slideshow/3.jpg') }}" alt=""></a></section>
                    <section class="item"><a class="w-100 d-block h-auto text-decoration-none" href="#"><img
                                class="w-100 rounded-2 d-block h-auto"
                                src="{{ asset('customer-assets/images/slideshow/4.jpg') }}" alt=""></a></section>
                    <section class="item"><a class="w-100 d-block h-auto text-decoration-none" href="#"><img
                                class="w-100 rounded-2 d-block h-auto"
                                src="{{ asset('customer-assets/images/slideshow/5.jpg') }}" alt=""></a></section>
                    <section class="item"><a class="w-100 d-block h-auto text-decoration-none" href="#"><img
                                class="w-100 rounded-2 d-block h-auto"
                                src="{{ asset('customer-assets/images/slideshow/6.gif') }}" alt=""></a></section>
                </section>
            </section>
            <section class="col-md-4 ps-md-1 mt-2 mt-md-0">
                <section class="mb-2"><a href="#" class="d-block"><img class="w-100 rounded-2"
                            src="{{ asset('customer-assets/images/slideshow/12.gif') }}" alt=""></a></section>
                <section class="mb-2"><a href="#" class="d-block"><img class="w-100 rounded-2"
                            src="{{ asset('customer-assets/images/slideshow/11.jpg') }}" alt=""></a></section>
            </section>
        </section>
    </section>
    <!-- end slideshow -->
                                        ...
                                        <section class="product">
                                            ...
                                            <a class="product-link" href="#">
                                                <section class="product-image">
                                                    <img class=""
                                                        src="{{ asset('customer-assets/images/products/21.jpg') }}">
                                                </section>
                                    ...
                                    <section class="lazyload-item-wrapper">
                                        <section class="product">
                                            ...
                                            <a class="product-link" href="#">
                                                <section class="product-image">
                                                    <img class=""
                                                        src="{{ asset('customer-assets/images/products/22.jpg') }}">
                                                </section>
                                                <section class="product-colors"></section>
                                                <section class="product-name">
                                    ...
                                    <section class="lazyload-item-wrapper">
                                        <section class="product">
                                            ...
                                            <a class="product-link" href="#">
                                                <section class="product-image">
                                                    <img class=""
                                                        src="{{ asset('customer-assets/images/products/17.jpg') }}">
                                                </section>
                                                <section class="product-name">
                                    ...
                                    <section class="lazyload-item-wrapper">
                                        <section class="product">
                                            ...
                                            <a class="product-link" href="#">
                                                <section class="product-image">
                                                    <img class=""
                                                        src="{{ asset('customer-assets/images/products/19.jpg') }}">
                                                </section>
                                                <section class="product-colors"></section>
                                                <section class="product-name">
                                    ...
                                    <section class="lazyload-item-wrapper">
                                        <section class="product">
                                            ...
                                            <a class="product-link" href="#">
                                                <section class="product-image">
                                                    <img class=""
                                                        src="{{ asset('customer-assets/images/products/20.jpg') }}">
                                    ...
                                    <section class="lazyload-item-wrapper">
                                        <section class="product">
                                            ...
                                            <a class="product-link" href="#">
                                                <section class="product-image">
                                                    <img class=""
                                                        src="{{ asset('customer-assets/images/products/18.jpg') }}">
                                    ...
                                    <section class="lazyload-item-wrapper">
                                        <section class="product">
                                            ...
                                            <a class="product-link" href="#">
                                                <section class="product-image">
                                                    <img class=""
                                                        src="{{ asset('customer-assets/images/products/16.jpg') }}">
                                    ...
                                    <section class="lazyload-item-wrapper">
                                        <section class="product">
                                            ...
                                            <a class="product-link" href="#">
                                                <section class="product-image">
                                                    <img class=""
                                                        src="{{ asset('customer-assets/images/products/14.jpg') }}">
                                    ...
                                    <section class="lazyload-item-wrapper">
                                        <section class="product">
                                            ...
                                            <a class="product-link" href="#">
                                                <section class="product-image">
                                                    <img class=""
                                                        src="{{ asset('customer-assets/images/products/10.jpg') }}">
                                    ...
                                    <section class="lazyload-item-wrapper">
                                        <section class="product">
                                            ...
                                            <a class="product-link" href="#">
                                                <section class="product-image">
                                                    <img class=""
                                                        src="{{ asset('customer-assets/images/products/11.jpg') }}">
                                                </section>
                                                <section class="product-colors"></section>
                                                <section class="product-name">
                                    ...
                                    <section class="lazyload-item-wrapper">
                                        <section class="product">
                                            ...
                                            <a class="product-link" href="#">
                                                <section class="product-image">
                                                    <img class=""
                                                        src="{{ asset('customer-assets/images/products/13.jpg') }}">
                                                </section>
                                                <section class="product-colors"></section>
                                                <section class="product-name">
        ...
        <section class="container-xxl">
            ...
            <section class="row py-4">
                <section class="col-12 col-md-6 mt-2 mt-md-0"><img class="d-block rounded-2 w-100"
                        src="{{ asset('customer-assets/images/ads/two-col-1.jpg') }}" alt=""></section>
                <section class="col-12 col-md-6 mt-2 mt-md-0"><img class="d-block rounded-2 w-100"
                        src="{{ asset('customer-assets/images/ads/two-col-2.jpg') }}" alt=""></section>
            </section>
                                    ...
                                    <section class="lazyload-item-wrapper">
                                        <section class="product">
                                            ...
                                            <a class="product-link" href="#">
                                                <section class="product-image">
                                                    <img class=""
                                                        src="{{ asset('customer-assets/images/products/5.jpg') }}">
                                                </section>
                                                <section class="product-colors"></section>
                                                <section class="product-name">
                                    ...
                                    <section class="lazyload-item-wrapper">
                                        <section class="product">
                                            ...
                                            <a class="product-link" href="#">
                                                <section class="product-image">
                                                    <img class=""
                                                        src="{{ asset('customer-assets/images/products/6.jpg') }}">
                                                </section>
                                                <section class="product-colors"></section>
                                                <section class="product-name">
                                    ...
                                    <section class="lazyload-item-wrapper">
                                        <section class="product">
                                            ...
                                            <a class="product-link" href="#">
                                                <section class="product-image">
                                                    <img class=""
                                                        src="{{ asset('customer-assets/images/products/7.jpg') }}">
                                                </section>
                                                <section class="product-colors"></section>
                                                <section class="product-name">
                                    ...
                                    <section class="lazyload-item-wrapper">
                                        <section class="product">
                                            ...
                                            <a class="product-link" href="#">
                                                <section class="product-image">
                                                    <img class=""
                                                        src="{{ asset('customer-assets/images/products/8.jpg') }}">
                                                </section>
                                                <section class="product-colors"></section>
                                                <section class="product-name">
                                    ...
                                    <section class="lazyload-item-wrapper">
                                        <section class="product">
                                            ...
                                            <a class="product-link" href="#">
                                                <section class="product-image">
                                                    <img class=""
                                                        src="{{ asset('customer-assets/images/products/9.jpg') }}">
                                                </section>
                                                <section class="product-colors"></section>
                                                <section class="product-name">
                                    ...
                                    <section class="lazyload-item-wrapper">
                                        <section class="product">
                                            ...
                                            <a class="product-link" href="#">
                                                <section class="product-image">
                                                    <img class=""
                                                        src="{{ asset('customer-assets/images/products/12.jpg') }}">
                                                </section>
                                                <section class="product-colors"></section>
                                                <section class="product-name">
        ...
        <section class="container-xxl">
            ...
            <section class="row py-4">
                <section class="col"><img class="d-block rounded-2 w-100"
                        src="{{ asset('customer-assets/images/ads/one-col-1.jpg') }}"></section>
            </section>
                            ...
                            <section class="item">
                                <section class="brand-item">
                                    <a href="#"><img class="rounded-2"
                                            src="{{ asset('customer-assets/images/brand/huawei.jpg') }}"
                                            alt=""></a>
                                </section>
                            </section>
                            <section class="item">
                                <section class="brand-item">
                                    <a href="#"><img class="rounded-2"
                                            src="{{ asset('customer-assets/images/brand/adata.png') }}"
                                            alt=""></a>
                                </section>
                            </section>
                            <section class="item">
                                <section class="brand-item">
                                    <a href="#"><img class="rounded-2"
                                            src="{{ asset('customer-assets/images/brand/casio.jpg') }}"
                                            alt=""></a>
                                </section>
                            </section>
                            <section class="item">
                                <section class="brand-item">
                                    <a href="#"><img class="rounded-2"
                                            src="{{ asset('customer-assets/images/brand/gplus.jpg') }}"
                                            alt=""></a>
                                </section>
                            </section>
                            <section class="item">
                                <section class="brand-item">
                                    <a href="#"><img class="rounded-2"
                                            src="{{ asset('customer-assets/images/brand/logitech.jpg') }}"
                                            alt=""></a>
                                </section>
                            </section>
                            <section class="item">
                                <section class="brand-item">
                                    <a href="#"><img class="rounded-2"
                                            src="{{ asset('customer-assets/images/brand/nokia.jpg') }}"
                                            alt=""></a>
                                </section>
                            </section>
                            <section class="item">
                                <section class="brand-item">
                                    <a href="#"><img class="rounded-2"
                                            src="{{ asset('customer-assets/images/brand/pakshoma.png') }}"
                                            alt=""></a>
                                </section>
                            </section>
                            <section class="item">
                                <section class="brand-item">
                                    <a href="#"><img class="rounded-2"
                                            src="{{ asset('customer-assets/images/brand/panasonic.png') }}"
                                            alt=""></a>
                                </section>
                            </section>
                            <section class="item">
                                <section class="brand-item">
                                    <a href="#"><img class="rounded-2"
                                            src="{{ asset('customer-assets/images/brand/parskhazar.png') }}"
                                            alt=""></a>
                                </section>
                            </section>
                            <section class="item">
                                <section class="brand-item">
                                    <a href="#"><img class="rounded-2"
                                            src="{{ asset('customer-assets/images/brand/samsung.png') }}"
                                            alt=""></a>
                                </section>
                            </section>
                            <section class="item">
                                <section class="brand-item">
                                    <a href="#"><img class="rounded-2"
                                            src="{{ asset('customer-assets/images/brand/snowa.png') }}"
                                            alt=""></a>
                                </section>
                            </section>
                            <section class="item">
                                <section class="brand-item">
                                    <a href="#"><img class="rounded-2"
                                            src="{{ asset('customer-assets/images/brand/xvision.png') }}"
                                            alt=""></a>
                                </section>
                            </section>
                        </section>
